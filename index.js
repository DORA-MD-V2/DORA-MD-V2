...
async function connectToWA() {
  ...
  console.log("Connecting DORA BOT");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("DORA BOT installed successful ✅");
      console.log("DORA BOT connected to whatsapp ✅");

      let up = `DORA BOT connected successful ✅`;
      let up1 = `Hello DORA, I made bot successful`;
      ...
      robin.sendMessage("9494743454928@s.whatsapp.net", {
        image: {
          url: `https://raw.githubusercontent.com/Dark-Robin/Bot-Helper/refs/heads/main/autoimage/Bot%20robin%20cs.jpg`,
        },
        caption: up1,
